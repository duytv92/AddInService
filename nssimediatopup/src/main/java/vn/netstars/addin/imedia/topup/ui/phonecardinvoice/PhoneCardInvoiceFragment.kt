package vn.netstars.addin.imedia.topup.ui.phonecardinvoice

import androidx.core.os.bundleOf
import com.afollestad.materialdialogs.MaterialDialog
import com.blankj.utilcode.util.FragmentUtils
import com.chad.library.adapter.base.entity.MultiItemEntity
import kotlinx.android.synthetic.main._nss_fragment_phone_card_invoice.*
...
import vn.netstars.addin.imedia.topup.ui.phonecard.PhoneCardViewModel
...
class PhoneCardInvoiceFragment private constructor(): BaseFragment<PhoneCardViewModel>() {

    companion object {
        private const val LIST_ITEM_IN_CART_KEY = "LIST_ITEM_IN_CART_KEY"
        fun newInstance(listItemInCart: ArrayList<CartItemModel>): PhoneCardInvoiceFragment {
            val args = bundleOf(
                LIST_ITEM_IN_CART_KEY to listItemInCart
            )
            val fragment = PhoneCardInvoiceFragment()
    ...
    override fun getLayoutResId(): Int = R.layout._nss_fragment_phone_card_invoice
